...
<h3>Thống kê Sản phẩm bán chạy trong tháng</h3>
 ...
 <select name="thang" id="thang">
	...
	<div id="product-report">
		...
		<div class='table-responsive'><table class='table'><tr><td>STT</td><td>Sản phẩm giá</td><td> Giá</td><td> Chiết Khấu</td> <td>Sô lượng</td></tr>
...
<script>
   ...
   $.ajax({
        ...
        url : url1+"baocao/banchay",// gửi ajax đến file result.php
        ...
        success : function (result){
            ...
            var i;
            var kt="";
            var out = "<div class='table-responsive'><table class='table'><tr><td>STT</td><td>Sản phẩm giá</td><td> Giá</td><td> Chiết Khấu</td> <td>Số lượng</td></tr>";
